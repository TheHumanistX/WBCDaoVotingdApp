...
export const EthersProvider = ({ children }) => {
    ...
    return (
        <EthersContext.Provider value={{
            ...
            <DaoProvider provider={provider} signer={signer}>
                <WrappedProvider provider={provider} signer={signer}>
                    <CrazyFacesMintingProvider provider={provider} signer={signer}>
                        <CrazyFacesProvider provider={provider} signer={signer}>
                            <TurtleCatCoinProvider provider={provider} signer={signer}>
                                {children}
