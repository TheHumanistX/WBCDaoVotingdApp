...
export const EthersProvider = ({ children }) => {
    ...
    console.log('Ethers Context called and running...')

    useEffect(() => {
        console.log('EthersContext - Entered useEffect...')
        const ethersDataSetup = async () => {
            console.log('EthersContext - entered ethersDataSetup...')
            try {
                if (window.ethereum) {
                    ...
                    if (network.chainId === 5) {
                        try {
                            ...
                            setSigner(signer)
                            console.log('EthersContext - signer: ', signer)
                            const userWallet = await signer.getAddress()
                            console.log('EthersContext - userWallet: ', userWallet)
