        ...
        <>
            ...
            <div className='nft-mint-modal__flex'>
                ...
                <p className='nft-mint-modal__cost-text'>
                    This will cost <span>{erc20Cost}</span> TurtleCatCoin (WBC), leaving you with <span>{erc20Remaining}</span> TurtleCatCoint (WBC).
                </p>
                <button className='nft-mint-modal__mint-button' onClick={handleMintNFTs}>
                    MINT NFTS
                </button>
                <div className='nft-mint-modal__close-x'>
                    X
                </div>
            </div>
        </>,
