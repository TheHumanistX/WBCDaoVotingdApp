      ...
      try {
        ...
        if (approvalReceipt.status === 1) {
          try {
            ...
            // TODO: Create another 'modal' or pop-up that will slide out in the top right on the page and inform the user they have succesfully minted ## nfts after the NftMintModal closes automatically.
