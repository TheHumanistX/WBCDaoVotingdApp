...
const TokenManagement = () => {
  ...
  const [nftMintModalIsOpen, setNftMintModalIsOpen] = useState(true)
  const [isOpen, setIsOpen] = useState(false)
  const [topText, setTopText] = useState('User Rejected Transaction')
  const [bottomText, setBottomText] = useState('See Console For More Information')
