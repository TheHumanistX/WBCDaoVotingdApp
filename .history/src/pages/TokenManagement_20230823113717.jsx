...
const TokenManagement = () => {
  ...
  const handleNFTMint = () => {
    ...
    console.log('User WBC Balance: ', userERC20Balance.toNumber())
  }
  ...
  const TOKEN_MANAGEMENT_MAP = [
    {
      ...
      buttonText: 'MINT',
      disableButtonCheck: userCanMintERC20,
    ...
    },
    {
      ...
      buttonText: 'MINT',
      disableButtonCheck: userCanMintNFT,
    ...
    },
    {
      ...
      buttonText: 'WRAP',
      disableButtonCheck: userCanWrapNFT,
        ...
        {TOKEN_MANAGEMENT_MAP.map((action, index) => {
          return (
            <TokenManagementOptions
              ...
              disableButtonCheck={action.disableButtonCheck}
