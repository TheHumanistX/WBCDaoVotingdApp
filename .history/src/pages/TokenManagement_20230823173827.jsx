  ...
  const handleNFTMint = async (quantityToMint) => {
    ...
    if (turtleCatCoinContract && crazyFacesMintingContract) {
      try {
        ...
        let totalNFTMintPrice = await crazyFacesMintingContract.functions[signatureWithArgs](quantityToMint);
        totalNFTMintPrice = ethers.utils.formatEther(totalNFTMintPrice)
